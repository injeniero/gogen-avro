...
const EnumTestRecordAvroCRC64Fingerprint = "m\xb3s\x86\x18Se\xe4"
...
func (r EnumTestRecord) Schema() string {
	return "{\"fields\":[{\"name\":\"EnumField\",\"type\":{\"default\":\"TestSymbol1\",\"doc\":\"Test \\nenum\",\"name\":\"TestEnumType\",\"symbols\":[\"TestSymbol3\",\"TestSymbol1\"],\"type\":\"enum\"}}],\"name\":\"EnumTestRecord\",\"type\":\"record\"}"
}
